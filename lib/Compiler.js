...
${other}`);
					...
					if (targetFile.match(/\/|\\/)) {
						...
						// Suggestion #1
						// Remove colon from paths to make it a valid Windows path
						console.log('Target file: ', targetFile);
						targetFile = targetFile.match(/^[a-zA-Z]:\\/) ? targetFile.replace(':', '') : targetFile;
						console.log('Target file after replace: ', targetFile);
						// Suggestion #2
						// Remove colon from paths to make it a valid Windows path
